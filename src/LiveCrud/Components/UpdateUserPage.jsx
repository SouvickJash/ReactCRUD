...
import {getEditData,UpdateUserData} from '../ApiData/Api'
...
setTimeout(() => {
  ...
  return (
    <>
        ...
        <h3  className="update"><u>Update User</u></h3> 
                <div>
                    <label> Name </label>
                ...
                <div>
                    <button type="submit" className="btn btn-primary px-4 py-2" onClick={() => UpdatedData()}>Update user</button>
                    <Link className="nav-link" to='/'>
                    <caption> <img src={backarrow} alt="" width="40" height="40"  onClick={()=>navigate(-1)} style={{marginTop:-55,marginLeft:133}}/></caption>
                   </Link>
                </div>
      </form>
    </>
